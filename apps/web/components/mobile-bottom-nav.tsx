...
export type MobileMoodleTab = "materials" | "tasks" | "script" | "formula" | "recordings";
...
export function MobileBottomNav({
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-50 border-t border-border bg-card/95 px-2 pt-2 pb-[max(0.65rem,env(safe-area-inset-bottom))] shadow-[0_-10px_30px_rgba(24,24,27,0.08)] backdrop-blur lg:hidden">
      <div className="mx-auto grid max-w-xl grid-cols-5 gap-1 px-1 pb-1">
        ...
        <MobileNavButton
          ...
          onClick={onScript}
        />
        <MobileNavButton active={activeTab === "formula"} icon={<Sigma />} label="Formeln" onClick={onFormula} />
